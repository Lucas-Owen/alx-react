...
export class Notifications extends React.PureComponent {
  ...
  render () {
    ...
    const { displayDrawer, listNotifications, handleDisplayDrawer, handleHideDrawer, markNotificationAsRead, setNotificationFilter } = this.props;
    // const listNotifications = useSelector(getUnreadNotifications, (a, b) => { return a.size == b.size; });
    return (
      <>
        {displayDrawer ?
...
function NotificationWithSelector (props) {
  ...
  return (
    <Notifications {...props} listNotifications={listNotifications} />
  );
}
